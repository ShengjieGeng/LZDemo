...
public class RequestManager {
    ...
    @IntDef({TYPE_GET, TYPE_POST_JSON,TYPE_POST_FORM})
     ...
     */
    public void requestSyn(String actionUrl,@RequestType int requestType, HashMap<String, String> paramsMap) {
        switch (requestType) {
            case TYPE_GET:
     ...
     * @param <T> 数据泛型
     **/
    public <T> Call requestAsyn(String actionUrl,@RequestType int requestType, HashMap<String, String> paramsMap, ReqCallBack<T> callBack) {
        Call call = null;
        switch (requestType) {
            case TYPE_GET:
    ...
    public <T> void downLoadFile(String fileUrl, final String destFileDir, final ReqCallBack<T> callBack) {
        final String fileName =fileUrl.substring(fileUrl.lastIndexOf("/"),fileUrl.length());
